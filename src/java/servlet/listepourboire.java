...
public class listepourboire extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<ListePourBoire> listepourboire = new Service().getPourBoire(date1 , date2);
            request.setAttribute("listepourboire", listepourboire);
            RequestDispatcher disp = request.getRequestDispatcher("template.jsp?page=liste-pour-boire");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(listepourboire.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
